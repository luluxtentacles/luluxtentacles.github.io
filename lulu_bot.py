...
WORK_TURN_RULE = (
    ...
    "nothing. Ordinary chat needs no tools - 'lol nice' is a complete answer, and "
    "the rule is not about that. It is about WORK: when a question needs "
    "looking up, make the tool call in the same "
