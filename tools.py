    ...
    },
    {
        ...
        "function": {
            ...
            "description": (
                ...
                "may open, and it is how I see a page before pushing it. "
                "Reach for `linkcheck` whenever I have moved, renamed or "
                "restructured anything on my site, and before I push a "
                "restructure: it is 'python linkcheck.py', it walks "
                "projects/site and names every internal link that goes nowhere "
                "- including the two things this box cannot otherwise tell me, "
                "a link whose capitalisation is wrong and one pointing at a "
                "folder with no index.html. Both work here and 404 on the live "
                "site. Every "
