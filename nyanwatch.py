...
def _brief(changes: dict, sweep_text: str, notes: list) -> str:
    ...
    bits.append(
        ...
        "- put what is worth KEEPING into my people dossier with learn_person - one "
        "fact per call, in my own words, only about someone I actually have a page "
        "on. name them as I know them.\n"
